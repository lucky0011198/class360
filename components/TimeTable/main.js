...
function HomeScreen({ route, navigation }) {
  ...
  const renderContent = () => (
    <ScrollView>
      ...
      >
        ...
        >
          <Text fontSize="xl" fontWeight="bold" color="black" mt="lg" ml="xl">
            {Subject}
          </Text>
          <Button
            px="md"
  ...
  const [loaded] = useFonts({
    Montserrat: require("../../assets/fonts/Roboto/Roboto-Bold.ttf"),
  });
  ...
  const addData = () => {
    if (Branch) {
      ...
      fetch(
        "https://us-central1-class360-303e1.cloudfunctions.net/app/create",
        requestOptions
      )
  ...
  const updateddata = (id, branch) => {
    ...
    fetch(
      "https://us-central1-class360-303e1.cloudfunctions.net/app/update",
      requestOptions
    )
      .then((response) => response.text())
      .then((result) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          >
            ...
            <Text style={{ fontFamily: "Montserrat", fontSize: 25 }}>
              {"\t"}
              {"\t"}Timetable
            </Text>
          </View>
